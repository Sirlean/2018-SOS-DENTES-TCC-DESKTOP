...
namespace SosDentes.ClnNegocios
{
    class clnPaciente
    {
        ...
        {
            comando = "Select id_Paciente as [CÓDIGO], NOME, TEL_FIXO AS [TELEFONE], CELULAR, EMAIL, RG, CPF, UPPER(ORIGEM) as ORIGEM from paciente Where nome like '%" + strDescicao + "%' and Ativo='1' order by id_Paciente";
